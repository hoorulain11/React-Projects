...
function Menu() {
  return (
   <>
     <div className="bg-gradient-to-r from-neutral-300 to-stone-400 w-full h-fit p-2">
     <h1 className='text-center p-6 mt-2 capitalize font-bold text-2xl'>food menu</h1>
     <div className="menu-cards flex justify-center gap-10 flex-wrap mt-3 mb-3 p-4 ">
     ...
     <h4 className="text-center text-pink-600 capitalize font-semibold"> see all foods</h4>
     </div>
   </>
  )
}
